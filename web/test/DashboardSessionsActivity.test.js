...
const { eventsStore, connectedStore, statsStore, eventRateStore, realtimeStore, sessionsStore } = vi.hoisted(() => {
  ...
  return {
    ...
    statsStore: writable({ totalTurns: 10, totalInputTokens: 5000, totalOutputTokens: 3000, totalCost: 0.05, toolCounts: {}, skillCounts: {}, agentCounts: {}, dailyTokens: {}, modelBreakdown: {}, memoryStats: { files: 5, size: 1000, lastAccess: null } }),
